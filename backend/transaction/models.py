...
class Product(models.Model):
    ...
    productID = models.DecimalField(decimal_places=0, max_digits=20)
...
class Order(models.Model):
    ...
    deliveryID = models.DecimalField(decimal_places=0, max_digits=20)
...
class Payment(models.Model):
    paymentId = models.DecimalField(decimal_places=0, max_digits=10)
