...
const Shop = ({ user, isLoading, products, loadProducts, ...props }) => {
    ...
    useEffect(() => {
        ...
        if (url.searchParams.has('min_sold')) setFilter('Popular')
                        ...
                        <ul className="nav nav-pills text-center flex-column px-1 min-vh-100 text-white" id="menu" style={{ backgroundColor: "#beb7a3"}}>
                            ...
                            <li>
                                ...
                                <ul className="collapse nav flex-column ms-1" id="categories" data-bs-parent="#menu">
                                    <li className="w-100">
                                        <a href="/products?category_name&?" className="nav-link px-0"> <span className="d-none d-sm-inline">Veggies</span></a>
                                    </li>
                                    <li>
